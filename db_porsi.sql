...
-- ----------------------------
-- Table structure for dt_biodata_surveyor
-- ----------------------------
DROP TABLE IF EXISTS `dt_biodata_surveyor`;
CREATE TABLE `dt_biodata_surveyor`  (
  ...
  `nohp` varchar(100) CHARACTER SET latin1 COLLATE latin1_swedish_ci NULL DEFAULT NULL,
  `foto` varchar(200) CHARACTER SET latin1 COLLATE latin1_swedish_ci NULL DEFAULT NULL,
  `kd_desa` varchar(100) CHARACTER SET latin1 COLLATE latin1_swedish_ci NULL DEFAULT NULL,
  `kd_kec` varchar(100) CHARACTER SET latin1 COLLATE latin1_swedish_ci NULL DEFAULT NULL,
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 4 CHARACTER SET = latin1 COLLATE = latin1_swedish_ci ROW_FORMAT = Compact;

-- ----------------------------
-- Records of dt_biodata_surveyor
-- ----------------------------
INSERT INTO `dt_biodata_surveyor` VALUES (3, 'Sulaiman Yahya', 'Laki-laki', 'Kepela Dusun', '081343931767', '', '75.03.04.2003', '75.03.04');
...
CREATE TABLE `dt_desa`  (
  `id_desa` varchar(20) CHARACTER SET latin1 COLLATE latin1_swedish_ci NOT NULL,
  `kd_kab` varchar(20) CHARACTER SET latin1 COLLATE latin1_swedish_ci NOT NULL,
  `kd_camat` varchar(20) CHARACTER SET latin1 COLLATE latin1_swedish_ci NOT NULL,
  `desa` varchar(30) CHARACTER SET latin1 COLLATE latin1_swedish_ci NOT NULL,
  PRIMARY KEY (`id_desa`) USING BTREE,
  INDEX `kd_camat`(`kd_camat` ASC) USING BTREE,
  CONSTRAINT `dt_desa_ibfk_1` FOREIGN KEY (`kd_camat`) REFERENCES `dt_kecamatan` (`id_kec`) ON DELETE CASCADE ON UPDATE CASCADE
) ENGINE = InnoDB CHARACTER SET = latin1 COLLATE = latin1_swedish_ci ROW_FORMAT = Compact;

-- ----------------------------
-- Records of dt_desa
-- ----------------------------
INSERT INTO `dt_desa` VALUES ('75.03.01.2004', '75.03', '75.03.01', 'TALUMOPATU');
INSERT INTO `dt_desa` VALUES ('75.03.01.2005', '75.03', '75.03.01', 'TALULOBUTU');
INSERT INTO `dt_desa` VALUES ('75.03.01.2006', '75.03', '75.03.01', 'DUNGGALA');
INSERT INTO `dt_desa` VALUES ('75.03.01.2007', '75.03', '75.03.01', 'LANGGE');
INSERT INTO `dt_desa` VALUES ('75.03.01.2027', '75.03', '75.03.01', 'TALULOBUTU SELATAN');
INSERT INTO `dt_desa` VALUES ('75.03.01.2028', '75.03', '75.03.01', 'KERAMAT');
INSERT INTO `dt_desa` VALUES ('75.03.01.2029', '75.03', '75.03.01', 'MERANTI');
INSERT INTO `dt_desa` VALUES ('75.03.02.1008', '75.03', '75.03.02', 'PADENGO');
INSERT INTO `dt_desa` VALUES ('75.03.02.1009', '75.03', '75.03.02', 'OLOHUTA');
INSERT INTO `dt_desa` VALUES ('75.03.02.1010', '75.03', '75.03.02', 'TUMBIHE');
INSERT INTO `dt_desa` VALUES ('75.03.02.1011', '75.03', '75.03.02', 'PAUWO');
INSERT INTO `dt_desa` VALUES ('75.03.02.1028', '75.03', '75.03.02', 'OLOHUTA UTARA');
INSERT INTO `dt_desa` VALUES ('75.03.02.2006', '75.03', '75.03.02', 'DUTOHE');
INSERT INTO `dt_desa` VALUES ('75.03.02.2007', '75.03', '75.03.02', 'TANGGILINGO');
INSERT INTO `dt_desa` VALUES ('75.03.02.2012', '75.03', '75.03.02', 'TOTO SELATAN');
INSERT INTO `dt_desa` VALUES ('75.03.02.2013', '75.03', '75.03.02', 'POOWO');
INSERT INTO `dt_desa` VALUES ('75.03.02.2024', '75.03', '75.03.02', 'TALANGO');
INSERT INTO `dt_desa` VALUES ('75.03.02.2026', '75.03', '75.03.02', 'POOWO BARAT');
INSERT INTO `dt_desa` VALUES ('75.03.02.2029', '75.03', '75.03.02', 'DUTOHE BARAT');
INSERT INTO `dt_desa` VALUES ('75.03.03.2011', '75.03', '75.03.03', 'TINGKOHUBU');
INSERT INTO `dt_desa` VALUES ('75.03.03.2012', '75.03', '75.03.03', 'BOLUDAWA');
INSERT INTO `dt_desa` VALUES ('75.03.03.2013', '75.03', '75.03.03', 'BUBE');
INSERT INTO `dt_desa` VALUES ('75.03.03.2014', '75.03', '75.03.03', 'HULUDUOTAMO');
INSERT INTO `dt_desa` VALUES ('75.03.03.2020', '75.03', '75.03.03', 'ULANTA');
INSERT INTO `dt_desa` VALUES ('75.03.03.2021', '75.03', '75.03.03', 'TINELO');
INSERT INTO `dt_desa` VALUES ('75.03.03.2022', '75.03', '75.03.03', 'BUBEYA');
INSERT INTO `dt_desa` VALUES ('75.03.03.2023', '75.03', '75.03.03', 'BUBE BARU');
INSERT INTO `dt_desa` VALUES ('75.03.03.2027', '75.03', '75.03.03', 'TINGKOHUBU TIMUR');
INSERT INTO `dt_desa` VALUES ('75.03.03.2028', '75.03', '75.03.03', 'HELUMO');
INSERT INTO `dt_desa` VALUES ('75.03.04.2003', '75.03', '75.03.04', 'TAMBOO');
INSERT INTO `dt_desa` VALUES ('75.03.04.2004', '75.03', '75.03.04', 'BILUNGALA');
INSERT INTO `dt_desa` VALUES ('75.03.04.2005', '75.03', '75.03.04', 'UABANGA');
INSERT INTO `dt_desa` VALUES ('75.03.04.2008', '75.03', '75.03.04', 'TOLOTIO');
INSERT INTO `dt_desa` VALUES ('75.03.04.2012', '75.03', '75.03.04', 'TONGO');
INSERT INTO `dt_desa` VALUES ('75.03.04.2025', '75.03', '75.03.04', 'BILUNGALA UTARA');
INSERT INTO `dt_desa` VALUES ('75.03.04.2026', '75.03', '75.03.04', 'TIHU');
INSERT INTO `dt_desa` VALUES ('75.03.04.2027', '75.03', '75.03.04', 'TUNAS JAYA');
INSERT INTO `dt_desa` VALUES ('75.03.04.2028', '75.03', '75.03.04', 'LEMBAH HIJAU');
INSERT INTO `dt_desa` VALUES ('75.03.04.2029', '75.03', '75.03.04', 'BATU HIJAU');
INSERT INTO `dt_desa` VALUES ('75.03.04.2031', '75.03', '75.03.04', 'OMBULO HIJAU');
INSERT INTO `dt_desa` VALUES ('75.03.04.2032', '75.03', '75.03.04', 'KEMIRI');
INSERT INTO `dt_desa` VALUES ('75.03.04.2033', '75.03', '75.03.04', 'PELITA HIJAU');
INSERT INTO `dt_desa` VALUES ('75.03.05.2001', '75.03', '75.03.05', 'BOIDU');
INSERT INTO `dt_desa` VALUES ('75.03.05.2002', '75.03', '75.03.05', 'BANDUNGAN');
INSERT INTO `dt_desa` VALUES ('75.03.05.2003', '75.03', '75.03.05', 'TUPA');
INSERT INTO `dt_desa` VALUES ('75.03.05.2004', '75.03', '75.03.05', 'LONGALO');
INSERT INTO `dt_desa` VALUES ('75.03.05.2009', '75.03', '75.03.05', 'TULOA');
INSERT INTO `dt_desa` VALUES ('75.03.05.2010', '75.03', '75.03.05', 'KOPI');
INSERT INTO `dt_desa` VALUES ('75.03.05.2011', '75.03', '75.03.05', 'LOMAYA');
INSERT INTO `dt_desa` VALUES ('75.03.05.2012', '75.03', '75.03.05', 'SUKA DAMAI');
INSERT INTO `dt_desa` VALUES ('75.03.05.2015', '75.03', '75.03.05', 'BUNUO');
INSERT INTO `dt_desa` VALUES ('75.03.06.2001', '75.03', '75.03.06', 'BONGOIME');
INSERT INTO `dt_desa` VALUES ('75.03.06.2002', '75.03', '75.03.06', 'BONGOPINI');
INSERT INTO `dt_desa` VALUES ('75.03.06.2003', '75.03', '75.03.06', 'TOTO UTARA');
INSERT INTO `dt_desa` VALUES ('75.03.06.2004', '75.03', '75.03.06', 'MOUTONG');
INSERT INTO `dt_desa` VALUES ('75.03.06.2005', '75.03', '75.03.06', 'TUNGGULO');
INSERT INTO `dt_desa` VALUES ('75.03.06.2006', '75.03', '75.03.06', 'LONUO');
INSERT INTO `dt_desa` VALUES ('75.03.06.2007', '75.03', '75.03.06', 'TAMBOO');
INSERT INTO `dt_desa` VALUES ('75.03.06.2008', '75.03', '75.03.06', 'ILOHELUMA');
INSERT INTO `dt_desa` VALUES ('75.03.06.2009', '75.03', '75.03.06', 'MOTILANGO');
INSERT INTO `dt_desa` VALUES ('75.03.06.2010', '75.03', '75.03.06', 'BUTU');
INSERT INTO `dt_desa` VALUES ('75.03.06.2011', '75.03', '75.03.06', 'PERMATA');
INSERT INTO `dt_desa` VALUES ('75.03.06.2012', '75.03', '75.03.06', 'TUNGGULO SELATAN');
INSERT INTO `dt_desa` VALUES ('75.03.06.2013', '75.03', '75.03.06', 'BONGOHULAWA');
INSERT INTO `dt_desa` VALUES ('75.03.06.2014', '75.03', '75.03.06', 'BERLIAN');
INSERT INTO `dt_desa` VALUES ('75.03.07.2001', '75.03', '75.03.07', 'TIMBUOLO');
INSERT INTO `dt_desa` VALUES ('75.03.07.2002', '75.03', '75.03.07', 'PANGGULO');
INSERT INTO `dt_desa` VALUES ('75.03.07.2003', '75.03', '75.03.07', 'LUWOHU');
INSERT INTO `dt_desa` VALUES ('75.03.07.2004', '75.03', '75.03.07', 'BUATA');
INSERT INTO `dt_desa` VALUES ('75.03.07.2005', '75.03', '75.03.07', 'TIMBUOLO TIMUR');
INSERT INTO `dt_desa` VALUES ('75.03.07.2006', '75.03', '75.03.07', 'TANAH PUTIH');
INSERT INTO `dt_desa` VALUES ('75.03.07.2007', '75.03', '75.03.07', 'PANGGULO BARAT');
INSERT INTO `dt_desa` VALUES ('75.03.07.2008', '75.03', '75.03.07', 'TIMBUOLO TENGAH');
INSERT INTO `dt_desa` VALUES ('75.03.07.2009', '75.03', '75.03.07', 'SUKMA');
INSERT INTO `dt_desa` VALUES ('75.03.08.2001', '75.03', '75.03.08', 'HUANGOBOTU');
INSERT INTO `dt_desa` VALUES ('75.03.08.2002', '75.03', '75.03.08', 'MOLUTABU');
INSERT INTO `dt_desa` VALUES ('75.03.08.2003', '75.03', '75.03.08', 'OLUHUTA');
INSERT INTO `dt_desa` VALUES ('75.03.08.2004', '75.03', '75.03.08', 'OLELE');
INSERT INTO `dt_desa` VALUES ('75.03.08.2005', '75.03', '75.03.08', 'BOTUTONUO');
INSERT INTO `dt_desa` VALUES ('75.03.08.2006', '75.03', '75.03.08', 'MODELOMO');
INSERT INTO `dt_desa` VALUES ('75.03.08.2007', '75.03', '75.03.08', 'BILUANGO');
INSERT INTO `dt_desa` VALUES ('75.03.08.2008', '75.03', '75.03.08', 'BOTUBARANI');
INSERT INTO `dt_desa` VALUES ('75.03.08.2009', '75.03', '75.03.08', 'BINTALAHE');
INSERT INTO `dt_desa` VALUES ('75.03.09.2001', '75.03', '75.03.09', 'TALUDAA');
INSERT INTO `dt_desa` VALUES ('75.03.09.2002', '75.03', '75.03.09', 'SOGITIA');
INSERT INTO `dt_desa` VALUES ('75.03.09.2003', '75.03', '75.03.09', 'MOODULIO');
INSERT INTO `dt_desa` VALUES ('75.03.09.2004', '75.03', '75.03.09', 'BILONLANTUNGA');
INSERT INTO `dt_desa` VALUES ('75.03.09.2005', '75.03', '75.03.09', 'INOGALUMA');
INSERT INTO `dt_desa` VALUES ('75.03.09.2006', '75.03', '75.03.09', 'MONANO');
INSERT INTO `dt_desa` VALUES ('75.03.09.2007', '75.03', '75.03.09', 'TUMBUH MEKAR');
INSERT INTO `dt_desa` VALUES ('75.03.09.2008', '75.03', '75.03.09', 'MOLAMAHU');
INSERT INTO `dt_desa` VALUES ('75.03.09.2009', '75.03', '75.03.09', 'MASIAGA');
INSERT INTO `dt_desa` VALUES ('75.03.09.2010', '75.03', '75.03.09', 'ILOHUUWA');
INSERT INTO `dt_desa` VALUES ('75.03.09.2011', '75.03', '75.03.09', 'MUARA BONE');
INSERT INTO `dt_desa` VALUES ('75.03.09.2012', '75.03', '75.03.09', 'CENDANA PUTIH');
INSERT INTO `dt_desa` VALUES ('75.03.09.2013', '75.03', '75.03.09', 'WALUHU');
INSERT INTO `dt_desa` VALUES ('75.03.09.2014', '75.03', '75.03.09', 'PERMATA');
INSERT INTO `dt_desa` VALUES ('75.03.10.2001', '75.03', '75.03.10', 'INOMATA');
INSERT INTO `dt_desa` VALUES ('75.03.10.2003', '75.03', '75.03.10', 'TUMBULILATO');
INSERT INTO `dt_desa` VALUES ('75.03.10.2004', '75.03', '75.03.10', 'MOOTAYU');
INSERT INTO `dt_desa` VALUES ('75.03.10.2006', '75.03', '75.03.10', 'MOOTINELO');
INSERT INTO `dt_desa` VALUES ('75.03.10.2009', '75.03', '75.03.10', 'PELITA JAYA');
INSERT INTO `dt_desa` VALUES ('75.03.10.2010', '75.03', '75.03.10', 'MOOPIYA');
INSERT INTO `dt_desa` VALUES ('75.03.10.2011', '75.03', '75.03.10', 'ALO');
INSERT INTO `dt_desa` VALUES ('75.03.10.2012', '75.03', '75.03.10', 'LAUT BIRU');
INSERT INTO `dt_desa` VALUES ('75.03.10.2014', '75.03', '75.03.10', 'BUNGA');
INSERT INTO `dt_desa` VALUES ('75.03.10.2015', '75.03', '75.03.10', 'MOOTAWA');
INSERT INTO `dt_desa` VALUES ('75.03.11.2001', '75.03', '75.03.11', 'TULABOLO');
INSERT INTO `dt_desa` VALUES ('75.03.11.2003', '75.03', '75.03.11', 'DUMBAYA BULAN');
INSERT INTO `dt_desa` VALUES ('75.03.11.2004', '75.03', '75.03.11', 'TULABOLO TIMUR');
INSERT INTO `dt_desa` VALUES ('75.03.11.2005', '75.03', '75.03.11', 'TILANGOBULA');
INSERT INTO `dt_desa` VALUES ('75.03.11.2007', '75.03', '75.03.11', 'PODUWOMA');
INSERT INTO `dt_desa` VALUES ('75.03.11.2008', '75.03', '75.03.11', 'PANGGULO');
INSERT INTO `dt_desa` VALUES ('75.03.11.2009', '75.03', '75.03.11', 'TULABOLO BARAT');
INSERT INTO `dt_desa` VALUES ('75.03.11.2010', '75.03', '75.03.11', 'PANGI');
INSERT INTO `dt_desa` VALUES ('75.03.11.2011', '75.03', '75.03.11', 'TINEMBA');
INSERT INTO `dt_desa` VALUES ('75.03.12.2001', '75.03', '75.03.12', 'BULONTALA');
INSERT INTO `dt_desa` VALUES ('75.03.12.2002', '75.03', '75.03.12', 'LIBUNGO');
INSERT INTO `dt_desa` VALUES ('75.03.12.2003', '75.03', '75.03.12', 'MOLINTOGUPO');
INSERT INTO `dt_desa` VALUES ('75.03.12.2004', '75.03', '75.03.12', 'BONEDAA');
INSERT INTO `dt_desa` VALUES ('75.03.12.2005', '75.03', '75.03.12', 'BONDAWUNA');
INSERT INTO `dt_desa` VALUES ('75.03.12.2006', '75.03', '75.03.12', 'BULONTALA TIMUR');
INSERT INTO `dt_desa` VALUES ('75.03.12.2007', '75.03', '75.03.12', 'PANCURAN');
INSERT INTO `dt_desa` VALUES ('75.03.12.2008', '75.03', '75.03.12', 'BONDARAYA');
INSERT INTO `dt_desa` VALUES ('75.03.13.2001', '75.03', '75.03.13', 'LOMPOTOO');
INSERT INTO `dt_desa` VALUES ('75.03.13.2002', '75.03', '75.03.13', 'LOMBONGO');
INSERT INTO `dt_desa` VALUES ('75.03.13.2003', '75.03', '75.03.13', 'DUANO');
INSERT INTO `dt_desa` VALUES ('75.03.13.2004', '75.03', '75.03.13', 'TOLOMATO');
INSERT INTO `dt_desa` VALUES ('75.03.13.2005', '75.03', '75.03.13', 'ALALE');
INSERT INTO `dt_desa` VALUES ('75.03.13.2006', '75.03', '75.03.13', 'TAPADAA');
INSERT INTO `dt_desa` VALUES ('75.03.14.2001', '75.03', '75.03.14', 'MONGIILO');
INSERT INTO `dt_desa` VALUES ('75.03.14.2002', '75.03', '75.03.14', 'OWATA');
INSERT INTO `dt_desa` VALUES ('75.03.14.2003', '75.03', '75.03.14', 'MONGIILO UTARA');
INSERT INTO `dt_desa` VALUES ('75.03.14.2004', '75.03', '75.03.14', 'PILOLAHEYA');
INSERT INTO `dt_desa` VALUES ('75.03.14.2005', '75.03', '75.03.14', 'ILOMATA');
INSERT INTO `dt_desa` VALUES ('75.03.14.2006', '75.03', '75.03.14', 'SUKA MAKMUR');
INSERT INTO `dt_desa` VALUES ('75.03.15.2001', '75.03', '75.03.15', 'AYULA SELATAN');
INSERT INTO `dt_desa` VALUES ('75.03.15.2002', '75.03', '75.03.15', 'HUNTU UTARA');
INSERT INTO `dt_desa` VALUES ('75.03.15.2003', '75.03', '75.03.15', 'AYULA UTARA');
INSERT INTO `dt_desa` VALUES ('75.03.15.2004', '75.03', '75.03.15', 'HUNTU SELATAN');
INSERT INTO `dt_desa` VALUES ('75.03.15.2006', '75.03', '75.03.15', 'AYULA TILANGO');
INSERT INTO `dt_desa` VALUES ('75.03.15.2007', '75.03', '75.03.15', 'AYULA TIMUR');
INSERT INTO `dt_desa` VALUES ('75.03.15.2008', '75.03', '75.03.15', 'LAMAHU');
INSERT INTO `dt_desa` VALUES ('75.03.15.2009', '75.03', '75.03.15', 'TINELO AYULA');
INSERT INTO `dt_desa` VALUES ('75.03.15.2010', '75.03', '75.03.15', 'SEJAHTERA');
INSERT INTO `dt_desa` VALUES ('75.03.15.2011', '75.03', '75.03.15', 'HUNTU BARAT');
INSERT INTO `dt_desa` VALUES ('75.03.16.2001', '75.03', '75.03.16', 'BULOTALANGI');
INSERT INTO `dt_desa` VALUES ('75.03.16.2002', '75.03', '75.03.16', 'TOLUWAYA');
INSERT INTO `dt_desa` VALUES ('75.03.16.2003', '75.03', '75.03.16', 'POPODU');
INSERT INTO `dt_desa` VALUES ('75.03.16.2004', '75.03', '75.03.16', 'BULOTALANGI TIMUR');
INSERT INTO `dt_desa` VALUES ('75.03.16.2005', '75.03', '75.03.16', 'BULOTALANGI BARAT');
INSERT INTO `dt_desa` VALUES ('75.03.17.2001', '75.03', '75.03.17', 'MAMUNGAA');
INSERT INTO `dt_desa` VALUES ('75.03.17.2002', '75.03', '75.03.17', 'KAIDUNDU BARAT');
INSERT INTO `dt_desa` VALUES ('75.03.17.2003', '75.03', '75.03.17', 'MOPUYA');
INSERT INTO `dt_desa` VALUES ('75.03.17.2004', '75.03', '75.03.17', 'KAIDUNDU');
INSERT INTO `dt_desa` VALUES ('75.03.17.2005', '75.03', '75.03.17', 'BUKIT HIJAU');
INSERT INTO `dt_desa` VALUES ('75.03.17.2006', '75.03', '75.03.17', 'MAMUNGAA TIMUR');
INSERT INTO `dt_desa` VALUES ('75.03.17.2007', '75.03', '75.03.17', 'DUNGGILATA');
INSERT INTO `dt_desa` VALUES ('75.03.17.2008', '75.03', '75.03.17', 'PINOMOTIGA');
INSERT INTO `dt_desa` VALUES ('75.03.17.2009', '75.03', '75.03.17', 'PATOA');
INSERT INTO `dt_desa` VALUES ('75.03.18.2001', '75.03', '75.03.18', 'PINOGU');
INSERT INTO `dt_desa` VALUES ('75.03.18.2002', '75.03', '75.03.18', 'BANGIO');
INSERT INTO `dt_desa` VALUES ('75.03.18.2003', '75.03', '75.03.18', 'DATARAN HIJAU');
INSERT INTO `dt_desa` VALUES ('75.03.18.2004', '75.03', '75.03.18', 'PINOGU PERMAI');
INSERT INTO `dt_desa` VALUES ('75.03.18.2005', '75.03', '75.03.18', 'TILONGGIBILA');

-- ----------------------------
-- Table structure for dt_kabupaten
-- ----------------------------
DROP TABLE IF EXISTS `dt_kabupaten`;
CREATE TABLE `dt_kabupaten`  (
  `id_kab` varchar(20) CHARACTER SET latin1 COLLATE latin1_swedish_ci NOT NULL,
  `kabupaten` varchar(20) CHARACTER SET latin1 COLLATE latin1_swedish_ci NOT NULL,
  PRIMARY KEY (`id_kab`) USING BTREE
) ENGINE = InnoDB CHARACTER SET = latin1 COLLATE = latin1_swedish_ci ROW_FORMAT = Compact;

-- ----------------------------
-- Records of dt_kabupaten
-- ----------------------------
INSERT INTO `dt_kabupaten` VALUES ('75.03', 'BONE BOLANGO');
...
CREATE TABLE `dt_kecamatan`  (
  `id_kec` varchar(20) CHARACTER SET latin1 COLLATE latin1_swedish_ci NOT NULL,
  `kd_kab` varchar(20) CHARACTER SET latin1 COLLATE latin1_swedish_ci NOT NULL,
  `kecamatan` varchar(20) CHARACTER SET latin1 COLLATE latin1_swedish_ci NOT NULL,
  PRIMARY KEY (`id_kec`) USING BTREE,
  INDEX `kd_kab`(`kd_kab` ASC) USING BTREE,
  CONSTRAINT `dt_kecamatan_ibfk_1` FOREIGN KEY (`kd_kab`) REFERENCES `dt_kabupaten` (`id_kab`) ON DELETE CASCADE ON UPDATE CASCADE
) ENGINE = InnoDB CHARACTER SET = latin1 COLLATE = latin1_swedish_ci ROW_FORMAT = Compact;

-- ----------------------------
-- Records of dt_kecamatan
-- ----------------------------
INSERT INTO `dt_kecamatan` VALUES ('75.03.01', '75.03', 'TAPA');
INSERT INTO `dt_kecamatan` VALUES ('75.03.02', '75.03', 'KABILA');
INSERT INTO `dt_kecamatan` VALUES ('75.03.03', '75.03', 'SUWAWA');
INSERT INTO `dt_kecamatan` VALUES ('75.03.04', '75.03', 'BONE PANTAI');
INSERT INTO `dt_kecamatan` VALUES ('75.03.05', '75.03', 'BULANGO UTARA');
INSERT INTO `dt_kecamatan` VALUES ('75.03.06', '75.03', 'TILONGKABILA');
INSERT INTO `dt_kecamatan` VALUES ('75.03.07', '75.03', 'BOTUPINGGE');
INSERT INTO `dt_kecamatan` VALUES ('75.03.08', '75.03', 'KABILA BONE');
INSERT INTO `dt_kecamatan` VALUES ('75.03.09', '75.03', 'BONE');
INSERT INTO `dt_kecamatan` VALUES ('75.03.10', '75.03', 'BONE RAYA');
INSERT INTO `dt_kecamatan` VALUES ('75.03.11', '75.03', 'SUWAWA TIMUR');
INSERT INTO `dt_kecamatan` VALUES ('75.03.12', '75.03', 'SUWAWA SELATAN');
INSERT INTO `dt_kecamatan` VALUES ('75.03.13', '75.03', 'SUWAWA TENGAH');
INSERT INTO `dt_kecamatan` VALUES ('75.03.14', '75.03', 'BULANGO ULU');
INSERT INTO `dt_kecamatan` VALUES ('75.03.15', '75.03', 'BULANGO SELATAN');
INSERT INTO `dt_kecamatan` VALUES ('75.03.16', '75.03', 'BULANGO TIMUR');
INSERT INTO `dt_kecamatan` VALUES ('75.03.17', '75.03', 'BULAWA');
INSERT INTO `dt_kecamatan` VALUES ('75.03.18', '75.03', 'PINOGU');

-- ----------------------------
-- Table structure for dt_skp
-- ----------------------------
DROP TABLE IF EXISTS `dt_skp`;
CREATE TABLE `dt_skp`  (
  `id` int NOT NULL AUTO_INCREMENT,
  `kd_kec` varchar(255) CHARACTER SET latin1 COLLATE latin1_swedish_ci NULL DEFAULT NULL,
  `kd_desa` varchar(255) CHARACTER SET latin1 COLLATE latin1_swedish_ci NULL DEFAULT NULL,
  `jenis_kegiatan` varchar(255) CHARACTER SET latin1 COLLATE latin1_swedish_ci NULL DEFAULT NULL,
  `sub_kegiatan` varchar(255) CHARACTER SET latin1 COLLATE latin1_swedish_ci NULL DEFAULT NULL,
  `tahun` varchar(255) CHARACTER SET latin1 COLLATE latin1_swedish_ci NULL DEFAULT NULL,
  `A1` varchar(225) CHARACTER SET latin1 COLLATE latin1_swedish_ci NOT NULL,
  `A2` varchar(225) CHARACTER SET latin1 COLLATE latin1_swedish_ci NOT NULL,
  `A3` varchar(255) CHARACTER SET latin1 COLLATE latin1_swedish_ci NULL DEFAULT NULL,
  `A4` varchar(225) CHARACTER SET latin1 COLLATE latin1_swedish_ci NOT NULL,
  `A5` varchar(225) CHARACTER SET latin1 COLLATE latin1_swedish_ci NOT NULL,
  `A6` varchar(225) CHARACTER SET latin1 COLLATE latin1_swedish_ci NOT NULL,
  ...
  `B6` varchar(255) CHARACTER SET latin1 COLLATE latin1_swedish_ci NULL DEFAULT NULL,
  `B7` varchar(255) CHARACTER SET latin1 COLLATE latin1_swedish_ci NULL DEFAULT NULL,
  ...
  `foto_A1` varchar(255) CHARACTER SET latin1 COLLATE latin1_swedish_ci NULL DEFAULT NULL,
  `foto_A2` varchar(255) CHARACTER SET latin1 COLLATE latin1_swedish_ci NULL DEFAULT NULL,
  `foto_A3` varchar(255) CHARACTER SET latin1 COLLATE latin1_swedish_ci NULL DEFAULT NULL,
  `foto_B1` varchar(255) CHARACTER SET latin1 COLLATE latin1_swedish_ci NULL DEFAULT NULL,
  `foto_B2` varchar(255) CHARACTER SET latin1 COLLATE latin1_swedish_ci NULL DEFAULT NULL,
  `foto_B3` varchar(255) CHARACTER SET latin1 COLLATE latin1_swedish_ci NULL DEFAULT NULL,
  `foto_B4` varchar(255) CHARACTER SET latin1 COLLATE latin1_swedish_ci NULL DEFAULT NULL,
  `foto_B5` varchar(255) CHARACTER SET latin1 COLLATE latin1_swedish_ci NULL DEFAULT NULL,
  `foto_B6` varchar(225) CHARACTER SET latin1 COLLATE latin1_swedish_ci NOT NULL,
  `foto_B7` varchar(255) CHARACTER SET latin1 COLLATE latin1_swedish_ci NULL DEFAULT NULL,
  `foto_C1` varchar(255) CHARACTER SET latin1 COLLATE latin1_swedish_ci NULL DEFAULT NULL,
  `foto_C2` varchar(255) CHARACTER SET latin1 COLLATE latin1_swedish_ci NULL DEFAULT NULL,
  `foto_C3` varchar(255) CHARACTER SET latin1 COLLATE latin1_swedish_ci NULL DEFAULT NULL,
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 6 CHARACTER SET = latin1 COLLATE = latin1_swedish_ci ROW_FORMAT = Compact STATS_AUTO_RECALC = 1;

-- ----------------------------
-- Records of dt_skp
-- ----------------------------
INSERT INTO `dt_skp` VALUES (5, '75.03.04', '75.03.04.2003', 'Pertanian', 'TES', '2023', 'ADA', 'ADA', 'ADA', 'ADA', 'ADA', 'ADA', 'ADA', 'ADA', 'ADA', 'ADA', 'ADA', 'ADA', 'ADA', 'ADA', 'ADA', 'ADA', 'Bolmut.jpg', 'BonBol.jpg', '', '', '', '', '', '', '', '', '', '', '');
...
CREATE TABLE `user`  (
  ...
  `kd_desa` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL,
  `kd_kec` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL,
...
-- Records of user
-- ----------------------------
INSERT INTO `user` VALUES (5, 'Sandhika Galih', 'sandhikagalih@unpas.ac.id', 'profile1.jpg', '$2y$10$nXnrqGQTjpvg58OtOB/N.evYQjVlz7KIW37oUSQSQ2EgNMD0Dgrzq', 1, NULL, NULL, 1, 1552120289);
INSERT INTO `user` VALUES (6, 'Doddy Ferdiansyah', 'doddy@gmail.com', 'profile.jpg', '$2y$10$FhGzXwwTWLN/yonJpDLR0.nKoeWlKWBoRG9bsk0jOAgbJ007XzeFO', 2, NULL, NULL, 1, 1552285263);
INSERT INTO `user` VALUES (11, 'Sandhika Galih', 'sandhikagalih@gmail.com', 'default.jpg', '$2y$10$0QYEK1pB2L.Rdo.ZQsJO5eeTSpdzT7PvHaEwsuEyGSs0J1Qf5BoSq', 2, NULL, NULL, 1, 1553151354);
INSERT INTO `user` VALUES (12, 'sul', 'sulaiman.yahya03@gmail.com', 'default.jp', 'sul', 1, NULL, NULL, 1, 1553151354);
INSERT INTO `user` VALUES (13, 'desa', 'sulaiman.yahya03@gmail.com', 'default.jp', 'desa', 2, NULL, NULL, 1, 0);
INSERT INTO `user` VALUES (14, 'TALUMOPATU', '', '', 'sementara', 2, '75.03.01.2004', '75.03.01', 1, 0);
INSERT INTO `user` VALUES (15, 'TALULOBUTU', '', '', 'sementara', 2, '75.03.01.2005', '75.03.01', 1, 0);
INSERT INTO `user` VALUES (16, 'DUNGGALA', '', '', 'sementara', 2, '75.03.01.2006', '75.03.01', 1, 0);
INSERT INTO `user` VALUES (17, 'LANGGE', '', '', 'sementara', 2, '75.03.01.2007', '75.03.01', 1, 0);
INSERT INTO `user` VALUES (18, 'TALULOBUTU SELATAN', '', '', 'sementara', 2, '75.03.01.2027', '75.03.01', 1, 0);
INSERT INTO `user` VALUES (19, 'KERAMAT', '', '', 'sementara', 2, '75.03.01.2028', '75.03.01', 1, 0);
INSERT INTO `user` VALUES (20, 'MERANTI', '', '', 'sementara', 2, '75.03.01.2029', '75.03.01', 1, 0);
INSERT INTO `user` VALUES (21, 'PADENGO', '', '', 'sementara', 2, '75.03.02.1008', '75.03.02', 1, 0);
INSERT INTO `user` VALUES (22, 'OLOHUTA', '', '', 'sementara', 2, '75.03.02.1009', '75.03.02', 1, 0);
INSERT INTO `user` VALUES (23, 'TUMBIHE', '', '', 'sementara', 2, '75.03.02.1010', '75.03.02', 1, 0);
INSERT INTO `user` VALUES (24, 'PAUWO', '', '', 'sementara', 2, '75.03.02.1011', '75.03.02', 1, 0);
INSERT INTO `user` VALUES (25, 'OLOHUTA UTARA', '', '', 'sementara', 2, '75.03.02.1028', '75.03.02', 1, 0);
INSERT INTO `user` VALUES (26, 'DUTOHE', '', '', 'sementara', 2, '75.03.02.2006', '75.03.02', 1, 0);
INSERT INTO `user` VALUES (27, 'TANGGILINGO', '', '', 'sementara', 2, '75.03.02.2007', '75.03.02', 1, 0);
INSERT INTO `user` VALUES (28, 'TOTO SELATAN', '', '', 'sementara', 2, '75.03.02.2012', '75.03.02', 1, 0);
INSERT INTO `user` VALUES (29, 'POOWO', '', '', 'sementara', 2, '75.03.02.2013', '75.03.02', 1, 0);
INSERT INTO `user` VALUES (30, 'TALANGO', '', '', 'sementara', 2, '75.03.02.2024', '75.03.02', 1, 0);
INSERT INTO `user` VALUES (31, 'POOWO BARAT', '', '', 'sementara', 2, '75.03.02.2026', '75.03.02', 1, 0);
INSERT INTO `user` VALUES (32, 'DUTOHE BARAT', '', '', 'sementara', 2, '75.03.02.2029', '75.03.02', 1, 0);
INSERT INTO `user` VALUES (33, 'TINGKOHUBU', '', '', 'sementara', 2, '75.03.03.2011', '75.03.03', 1, 0);
INSERT INTO `user` VALUES (34, 'BOLUDAWA', '', '', 'sementara', 2, '75.03.03.2012', '75.03.03', 1, 0);
INSERT INTO `user` VALUES (35, 'BUBE', '', '', 'sementara', 2, '75.03.03.2013', '75.03.03', 1, 0);
INSERT INTO `user` VALUES (36, 'HULUDUOTAMO', '', '', 'sementara', 2, '75.03.03.2014', '75.03.03', 1, 0);
INSERT INTO `user` VALUES (37, 'ULANTA', '', '', 'sementara', 2, '75.03.03.2020', '75.03.03', 1, 0);
INSERT INTO `user` VALUES (38, 'TINELO', '', '', 'sementara', 2, '75.03.03.2021', '75.03.03', 1, 0);
INSERT INTO `user` VALUES (39, 'BUBEYA', '', '', 'sementara', 2, '75.03.03.2022', '75.03.03', 1, 0);
INSERT INTO `user` VALUES (40, 'BUBE BARU', '', '', 'sementara', 2, '75.03.03.2023', '75.03.03', 1, 0);
INSERT INTO `user` VALUES (41, 'TINGKOHUBU TIMUR', '', '', 'sementara', 2, '75.03.03.2027', '75.03.03', 1, 0);
INSERT INTO `user` VALUES (42, 'HELUMO', '', '', 'sementara', 2, '75.03.03.2028', '75.03.03', 1, 0);
INSERT INTO `user` VALUES (43, 'TAMBOO', '', '', 'sementara', 2, '75.03.04.2003', '75.03.04', 1, 0);
INSERT INTO `user` VALUES (44, 'BILUNGALA', '', '', 'sementara', 2, '75.03.04.2004', '75.03.04', 1, 0);
INSERT INTO `user` VALUES (45, 'UABANGA', '', '', 'sementara', 2, '75.03.04.2005', '75.03.04', 1, 0);
INSERT INTO `user` VALUES (46, 'TOLOTIO', '', '', 'sementara', 2, '75.03.04.2008', '75.03.04', 1, 0);
INSERT INTO `user` VALUES (47, 'TONGO', '', '', 'sementara', 2, '75.03.04.2012', '75.03.04', 1, 0);
INSERT INTO `user` VALUES (48, 'BILUNGALA UTARA', '', '', 'sementara', 2, '75.03.04.2025', '75.03.04', 1, 0);
INSERT INTO `user` VALUES (49, 'TIHU', '', '', 'sementara', 2, '75.03.04.2026', '75.03.04', 1, 0);
INSERT INTO `user` VALUES (50, 'TUNAS JAYA', '', '', 'sementara', 2, '75.03.04.2027', '75.03.04', 1, 0);
INSERT INTO `user` VALUES (51, 'LEMBAH HIJAU', '', '', 'sementara', 2, '75.03.04.2028', '75.03.04', 1, 0);
INSERT INTO `user` VALUES (52, 'BATU HIJAU', '', '', 'sementara', 2, '75.03.04.2029', '75.03.04', 1, 0);
INSERT INTO `user` VALUES (53, 'OMBULO HIJAU', '', '', 'sementara', 2, '75.03.04.2031', '75.03.04', 1, 0);
INSERT INTO `user` VALUES (54, 'KEMIRI', '', '', 'sementara', 2, '75.03.04.2032', '75.03.04', 1, 0);
INSERT INTO `user` VALUES (55, 'PELITA HIJAU', '', '', 'sementara', 2, '75.03.04.2033', '75.03.04', 1, 0);
INSERT INTO `user` VALUES (56, 'BOIDU', '', '', 'sementara', 2, '75.03.05.2001', '75.03.05', 1, 0);
INSERT INTO `user` VALUES (57, 'BANDUNGAN', '', '', 'sementara', 2, '75.03.05.2002', '75.03.05', 1, 0);
INSERT INTO `user` VALUES (58, 'TUPA', '', '', 'sementara', 2, '75.03.05.2003', '75.03.05', 1, 0);
INSERT INTO `user` VALUES (59, 'LONGALO', '', '', 'sementara', 2, '75.03.05.2004', '75.03.05', 1, 0);
INSERT INTO `user` VALUES (60, 'TULOA', '', '', 'sementara', 2, '75.03.05.2009', '75.03.05', 1, 0);
INSERT INTO `user` VALUES (61, 'KOPI', '', '', 'sementara', 2, '75.03.05.2010', '75.03.05', 1, 0);
INSERT INTO `user` VALUES (62, 'LOMAYA', '', '', 'sementara', 2, '75.03.05.2011', '75.03.05', 1, 0);
INSERT INTO `user` VALUES (63, 'SUKA DAMAI', '', '', 'sementara', 2, '75.03.05.2012', '75.03.05', 1, 0);
INSERT INTO `user` VALUES (64, 'BUNUO', '', '', 'sementara', 2, '75.03.05.2015', '75.03.05', 1, 0);
INSERT INTO `user` VALUES (65, 'BONGOIME', '', '', 'sementara', 2, '75.03.06.2001', '75.03.06', 1, 0);
INSERT INTO `user` VALUES (66, 'BONGOPINI', '', '', 'sementara', 2, '75.03.06.2002', '75.03.06', 1, 0);
INSERT INTO `user` VALUES (67, 'TOTO UTARA', '', '', 'sementara', 2, '75.03.06.2003', '75.03.06', 1, 0);
INSERT INTO `user` VALUES (68, 'MOUTONG', '', '', 'sementara', 2, '75.03.06.2004', '75.03.06', 1, 0);
INSERT INTO `user` VALUES (69, 'TUNGGULO', '', '', 'sementara', 2, '75.03.06.2005', '75.03.06', 1, 0);
INSERT INTO `user` VALUES (70, 'LONUO', '', '', 'sementara', 2, '75.03.06.2006', '75.03.06', 1, 0);
INSERT INTO `user` VALUES (71, 'TAMBOO', '', '', 'sementara', 2, '75.03.06.2007', '75.03.06', 1, 0);
INSERT INTO `user` VALUES (72, 'ILOHELUMA', '', '', 'sementara', 2, '75.03.06.2008', '75.03.06', 1, 0);
INSERT INTO `user` VALUES (73, 'MOTILANGO', '', '', 'sementara', 2, '75.03.06.2009', '75.03.06', 1, 0);
INSERT INTO `user` VALUES (74, 'BUTU', '', '', 'sementara', 2, '75.03.06.2010', '75.03.06', 1, 0);
INSERT INTO `user` VALUES (75, 'PERMATA', '', '', 'sementara', 2, '75.03.06.2011', '75.03.06', 1, 0);
INSERT INTO `user` VALUES (76, 'TUNGGULO SELATAN', '', '', 'sementara', 2, '75.03.06.2012', '75.03.06', 1, 0);
INSERT INTO `user` VALUES (77, 'BONGOHULAWA', '', '', 'sementara', 2, '75.03.06.2013', '75.03.06', 1, 0);
INSERT INTO `user` VALUES (78, 'BERLIAN', '', '', 'sementara', 2, '75.03.06.2014', '75.03.06', 1, 0);
INSERT INTO `user` VALUES (79, 'TIMBUOLO', '', '', 'sementara', 2, '75.03.07.2001', '75.03.07', 1, 0);
INSERT INTO `user` VALUES (80, 'PANGGULO', '', '', 'sementara', 2, '75.03.07.2002', '75.03.07', 1, 0);
INSERT INTO `user` VALUES (81, 'LUWOHU', '', '', 'sementara', 2, '75.03.07.2003', '75.03.07', 1, 0);
INSERT INTO `user` VALUES (82, 'BUATA', '', '', 'sementara', 2, '75.03.07.2004', '75.03.07', 1, 0);
INSERT INTO `user` VALUES (83, 'TIMBUOLO TIMUR', '', '', 'sementara', 2, '75.03.07.2005', '75.03.07', 1, 0);
INSERT INTO `user` VALUES (84, 'TANAH PUTIH', '', '', 'sementara', 2, '75.03.07.2006', '75.03.07', 1, 0);
INSERT INTO `user` VALUES (85, 'PANGGULO BARAT', '', '', 'sementara', 2, '75.03.07.2007', '75.03.07', 1, 0);
INSERT INTO `user` VALUES (86, 'TIMBUOLO TENGAH', '', '', 'sementara', 2, '75.03.07.2008', '75.03.07', 1, 0);
INSERT INTO `user` VALUES (87, 'SUKMA', '', '', 'sementara', 2, '75.03.07.2009', '75.03.07', 1, 0);
INSERT INTO `user` VALUES (88, 'HUANGOBOTU', '', '', 'sementara', 2, '75.03.08.2001', '75.03.08', 1, 0);
INSERT INTO `user` VALUES (89, 'MOLUTABU', '', '', 'sementara', 2, '75.03.08.2002', '75.03.08', 1, 0);
INSERT INTO `user` VALUES (90, 'OLUHUTA', '', '', 'sementara', 2, '75.03.08.2003', '75.03.08', 1, 0);
INSERT INTO `user` VALUES (91, 'OLELE', '', '', 'sementara', 2, '75.03.08.2004', '75.03.08', 1, 0);
INSERT INTO `user` VALUES (92, 'BOTUTONUO', '', '', 'sementara', 2, '75.03.08.2005', '75.03.08', 1, 0);
INSERT INTO `user` VALUES (93, 'MODELOMO', '', '', 'sementara', 2, '75.03.08.2006', '75.03.08', 1, 0);
INSERT INTO `user` VALUES (94, 'BILUANGO', '', '', 'sementara', 2, '75.03.08.2007', '75.03.08', 1, 0);
INSERT INTO `user` VALUES (95, 'BOTUBARANI', '', '', 'sementara', 2, '75.03.08.2008', '75.03.08', 1, 0);
INSERT INTO `user` VALUES (96, 'BINTALAHE', '', '', 'sementara', 2, '75.03.08.2009', '75.03.08', 1, 0);
INSERT INTO `user` VALUES (97, 'TALUDAA', '', '', 'sementara', 2, '75.03.09.2001', '75.03.09', 1, 0);
INSERT INTO `user` VALUES (98, 'SOGITIA', '', '', 'sementara', 2, '75.03.09.2002', '75.03.09', 1, 0);
INSERT INTO `user` VALUES (99, 'MOODULIO', '', '', 'sementara', 2, '75.03.09.2003', '75.03.09', 1, 0);
INSERT INTO `user` VALUES (100, 'BILONLANTUNGA', '', '', 'sementara', 2, '75.03.09.2004', '75.03.09', 1, 0);
INSERT INTO `user` VALUES (101, 'INOGALUMA', '', '', 'sementara', 2, '75.03.09.2005', '75.03.09', 1, 0);
INSERT INTO `user` VALUES (102, 'MONANO', '', '', 'sementara', 2, '75.03.09.2006', '75.03.09', 1, 0);
INSERT INTO `user` VALUES (103, 'TUMBUH MEKAR', '', '', 'sementara', 2, '75.03.09.2007', '75.03.09', 1, 0);
INSERT INTO `user` VALUES (104, 'MOLAMAHU', '', '', 'sementara', 2, '75.03.09.2008', '75.03.09', 1, 0);
INSERT INTO `user` VALUES (105, 'MASIAGA', '', '', 'sementara', 2, '75.03.09.2009', '75.03.09', 1, 0);
INSERT INTO `user` VALUES (106, 'ILOHUUWA', '', '', 'sementara', 2, '75.03.09.2010', '75.03.09', 1, 0);
INSERT INTO `user` VALUES (107, 'MUARA BONE', '', '', 'sementara', 2, '75.03.09.2011', '75.03.09', 1, 0);
INSERT INTO `user` VALUES (108, 'CENDANA PUTIH', '', '', 'sementara', 2, '75.03.09.2012', '75.03.09', 1, 0);
INSERT INTO `user` VALUES (109, 'WALUHU', '', '', 'sementara', 2, '75.03.09.2013', '75.03.09', 1, 0);
INSERT INTO `user` VALUES (110, 'PERMATA', '', '', 'sementara', 2, '75.03.09.2014', '75.03.09', 1, 0);
INSERT INTO `user` VALUES (111, 'INOMATA', '', '', 'sementara', 2, '75.03.10.2001', '75.03.10', 1, 0);
INSERT INTO `user` VALUES (112, 'TUMBULILATO', '', '', 'sementara', 2, '75.03.10.2003', '75.03.10', 1, 0);
INSERT INTO `user` VALUES (113, 'MOOTAYU', '', '', 'sementara', 2, '75.03.10.2004', '75.03.10', 1, 0);
INSERT INTO `user` VALUES (114, 'MOOTINELO', '', '', 'sementara', 2, '75.03.10.2006', '75.03.10', 1, 0);
INSERT INTO `user` VALUES (115, 'PELITA JAYA', '', '', 'sementara', 2, '75.03.10.2009', '75.03.10', 1, 0);
INSERT INTO `user` VALUES (116, 'MOOPIYA', '', '', 'sementara', 2, '75.03.10.2010', '75.03.10', 1, 0);
INSERT INTO `user` VALUES (117, 'ALO', '', '', 'sementara', 2, '75.03.10.2011', '75.03.10', 1, 0);
INSERT INTO `user` VALUES (118, 'LAUT BIRU', '', '', 'sementara', 2, '75.03.10.2012', '75.03.10', 1, 0);
INSERT INTO `user` VALUES (119, 'BUNGA', '', '', 'sementara', 2, '75.03.10.2014', '75.03.10', 1, 0);
INSERT INTO `user` VALUES (120, 'MOOTAWA', '', '', 'sementara', 2, '75.03.10.2015', '75.03.10', 1, 0);
INSERT INTO `user` VALUES (121, 'TULABOLO', '', '', 'sementara', 2, '75.03.11.2001', '75.03.11', 1, 0);
INSERT INTO `user` VALUES (122, 'DUMBAYA BULAN', '', '', 'sementara', 2, '75.03.11.2003', '75.03.11', 1, 0);
INSERT INTO `user` VALUES (123, 'TULABOLO TIMUR', '', '', 'sementara', 2, '75.03.11.2004', '75.03.11', 1, 0);
INSERT INTO `user` VALUES (124, 'TILANGOBULA', '', '', 'sementara', 2, '75.03.11.2005', '75.03.11', 1, 0);
INSERT INTO `user` VALUES (125, 'PODUWOMA', '', '', 'sementara', 2, '75.03.11.2007', '75.03.11', 1, 0);
INSERT INTO `user` VALUES (126, 'PANGGULO', '', '', 'sementara', 2, '75.03.11.2008', '75.03.11', 1, 0);
INSERT INTO `user` VALUES (127, 'TULABOLO BARAT', '', '', 'sementara', 2, '75.03.11.2009', '75.03.11', 1, 0);
INSERT INTO `user` VALUES (128, 'PANGI', '', '', 'sementara', 2, '75.03.11.2010', '75.03.11', 1, 0);
INSERT INTO `user` VALUES (129, 'TINEMBA', '', '', 'sementara', 2, '75.03.11.2011', '75.03.11', 1, 0);
INSERT INTO `user` VALUES (130, 'BULONTALA', '', '', 'sementara', 2, '75.03.12.2001', '75.03.12', 1, 0);
INSERT INTO `user` VALUES (131, 'LIBUNGO', '', '', 'sementara', 2, '75.03.12.2002', '75.03.12', 1, 0);
INSERT INTO `user` VALUES (132, 'MOLINTOGUPO', '', '', 'sementara', 2, '75.03.12.2003', '75.03.12', 1, 0);
INSERT INTO `user` VALUES (133, 'BONEDAA', '', '', 'sementara', 2, '75.03.12.2004', '75.03.12', 1, 0);
INSERT INTO `user` VALUES (134, 'BONDAWUNA', '', '', 'sementara', 2, '75.03.12.2005', '75.03.12', 1, 0);
INSERT INTO `user` VALUES (135, 'BULONTALA TIMUR', '', '', 'sementara', 2, '75.03.12.2006', '75.03.12', 1, 0);
INSERT INTO `user` VALUES (136, 'PANCURAN', '', '', 'sementara', 2, '75.03.12.2007', '75.03.12', 1, 0);
INSERT INTO `user` VALUES (137, 'BONDARAYA', '', '', 'sementara', 2, '75.03.12.2008', '75.03.12', 1, 0);
INSERT INTO `user` VALUES (138, 'LOMPOTOO', '', '', 'sementara', 2, '75.03.13.2001', '75.03.13', 1, 0);
INSERT INTO `user` VALUES (139, 'LOMBONGO', '', '', 'sementara', 2, '75.03.13.2002', '75.03.13', 1, 0);
INSERT INTO `user` VALUES (140, 'DUANO', '', '', 'sementara', 2, '75.03.13.2003', '75.03.13', 1, 0);
INSERT INTO `user` VALUES (141, 'TOLOMATO', '', '', 'sementara', 2, '75.03.13.2004', '75.03.13', 1, 0);
INSERT INTO `user` VALUES (142, 'ALALE', '', '', 'sementara', 2, '75.03.13.2005', '75.03.13', 1, 0);
INSERT INTO `user` VALUES (143, 'TAPADAA', '', '', 'sementara', 2, '75.03.13.2006', '75.03.13', 1, 0);
INSERT INTO `user` VALUES (144, 'MONGIILO', '', '', 'sementara', 2, '75.03.14.2001', '75.03.14', 1, 0);
INSERT INTO `user` VALUES (145, 'OWATA', '', '', 'sementara', 2, '75.03.14.2002', '75.03.14', 1, 0);
INSERT INTO `user` VALUES (146, 'MONGIILO UTARA', '', '', 'sementara', 2, '75.03.14.2003', '75.03.14', 1, 0);
INSERT INTO `user` VALUES (147, 'PILOLAHEYA', '', '', 'sementara', 2, '75.03.14.2004', '75.03.14', 1, 0);
INSERT INTO `user` VALUES (148, 'ILOMATA', '', '', 'sementara', 2, '75.03.14.2005', '75.03.14', 1, 0);
INSERT INTO `user` VALUES (149, 'SUKA MAKMUR', '', '', 'sementara', 2, '75.03.14.2006', '75.03.14', 1, 0);
INSERT INTO `user` VALUES (150, 'AYULA SELATAN', '', '', 'sementara', 2, '75.03.15.2001', '75.03.15', 1, 0);
INSERT INTO `user` VALUES (151, 'HUNTU UTARA', '', '', 'sementara', 2, '75.03.15.2002', '75.03.15', 1, 0);
INSERT INTO `user` VALUES (152, 'AYULA UTARA', '', '', 'sementara', 2, '75.03.15.2003', '75.03.15', 1, 0);
INSERT INTO `user` VALUES (153, 'HUNTU SELATAN', '', '', 'sementara', 2, '75.03.15.2004', '75.03.15', 1, 0);
INSERT INTO `user` VALUES (154, 'AYULA TILANGO', '', '', 'sementara', 2, '75.03.15.2006', '75.03.15', 1, 0);
INSERT INTO `user` VALUES (155, 'AYULA TIMUR', '', '', 'sementara', 2, '75.03.15.2007', '75.03.15', 1, 0);
INSERT INTO `user` VALUES (156, 'LAMAHU', '', '', 'sementara', 2, '75.03.15.2008', '75.03.15', 1, 0);
INSERT INTO `user` VALUES (157, 'TINELO AYULA', '', '', 'sementara', 2, '75.03.15.2009', '75.03.15', 1, 0);
INSERT INTO `user` VALUES (158, 'SEJAHTERA', '', '', 'sementara', 2, '75.03.15.2010', '75.03.15', 1, 0);
INSERT INTO `user` VALUES (159, 'HUNTU BARAT', '', '', 'sementara', 2, '75.03.15.2011', '75.03.15', 1, 0);
INSERT INTO `user` VALUES (160, 'BULOTALANGI', '', '', 'sementara', 2, '75.03.16.2001', '75.03.16', 1, 0);
INSERT INTO `user` VALUES (161, 'TOLUWAYA', '', '', 'sementara', 2, '75.03.16.2002', '75.03.16', 1, 0);
INSERT INTO `user` VALUES (162, 'POPODU', '', '', 'sementara', 2, '75.03.16.2003', '75.03.16', 1, 0);
INSERT INTO `user` VALUES (163, 'BULOTALANGI TIMUR', '', '', 'sementara', 2, '75.03.16.2004', '75.03.16', 1, 0);
INSERT INTO `user` VALUES (164, 'BULOTALANGI BARAT', '', '', 'sementara', 2, '75.03.16.2005', '75.03.16', 1, 0);
INSERT INTO `user` VALUES (165, 'MAMUNGAA', '', '', 'sementara', 2, '75.03.17.2001', '75.03.17', 1, 0);
INSERT INTO `user` VALUES (166, 'KAIDUNDU BARAT', '', '', 'sementara', 2, '75.03.17.2002', '75.03.17', 1, 0);
INSERT INTO `user` VALUES (167, 'MOPUYA', '', '', 'sementara', 2, '75.03.17.2003', '75.03.17', 1, 0);
INSERT INTO `user` VALUES (168, 'KAIDUNDU', '', '', 'sementara', 2, '75.03.17.2004', '75.03.17', 1, 0);
INSERT INTO `user` VALUES (169, 'BUKIT HIJAU', '', '', 'sementara', 2, '75.03.17.2005', '75.03.17', 1, 0);
INSERT INTO `user` VALUES (170, 'MAMUNGAA TIMUR', '', '', 'sementara', 2, '75.03.17.2006', '75.03.17', 1, 0);
INSERT INTO `user` VALUES (171, 'DUNGGILATA', '', '', 'sementara', 2, '75.03.17.2007', '75.03.17', 1, 0);
INSERT INTO `user` VALUES (172, 'PINOMOTIGA', '', '', 'sementara', 2, '75.03.17.2008', '75.03.17', 1, 0);
INSERT INTO `user` VALUES (173, 'PATOA', '', '', 'sementara', 2, '75.03.17.2009', '75.03.17', 1, 0);
INSERT INTO `user` VALUES (174, 'PINOGU', '', '', 'sementara', 2, '75.03.18.2001', '75.03.18', 1, 0);
INSERT INTO `user` VALUES (175, 'BANGIO', '', '', 'sementara', 2, '75.03.18.2002', '75.03.18', 1, 0);
INSERT INTO `user` VALUES (176, 'DATARAN HIJAU', '', '', 'sementara', 2, '75.03.18.2003', '75.03.18', 1, 0);
INSERT INTO `user` VALUES (177, 'PINOGU PERMAI', '', '', 'sementara', 2, '75.03.18.2004', '75.03.18', 1, 0);
INSERT INTO `user` VALUES (178, 'TILONGGIBILA', '', '', 'sementara', 2, '75.03.18.2005', '75.03.18', 1, 0);
...
INSERT INTO `user_access_menu` VALUES (12, 1, 6);
INSERT INTO `user_access_menu` VALUES (13, 1, 7);
INSERT INTO `user_access_menu` VALUES (14, 2, 8);
...
CREATE TABLE `user_menu`  (
  ...
  `ikon` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL,
...
-- ----------------------------
INSERT INTO `user_menu` VALUES (1, 'Informasi', 'mdi mdi-newspaper menu-icon', 1);
INSERT INTO `user_menu` VALUES (2, 'Dokumen', 'mdi mdi-file-pdf-box menu-icon', 0);
INSERT INTO `user_menu` VALUES (3, 'Entry Data', 'mdi mdi-keyboard menu-icon', 1);
INSERT INTO `user_menu` VALUES (4, 'Laporan', 'mdi mdi-file-chart menu-icon', 1);
INSERT INTO `user_menu` VALUES (5, 'Admin', 'mdi mdi-account menu-icon', 1);
INSERT INTO `user_menu` VALUES (6, 'User', 'mdi mdi-account menu-icon', 1);
INSERT INTO `user_menu` VALUES (7, 'Menu', 'mdi mdi-account menu-icon', 1);
INSERT INTO `user_menu` VALUES (8, 'SKP', 'mdi mdi-finance menu-icon', 1);
...
-- ----------------------------
INSERT INTO `user_sub_menu` VALUES (1, 5, 'Dashboard', 'admin', 'fas fa-fw fa-tachometer-alt', 1);
INSERT INTO `user_sub_menu` VALUES (2, 6, 'My Profile', 'user', 'fas fa-fw fa-user', 1);
INSERT INTO `user_sub_menu` VALUES (3, 6, 'Edit Profile', 'user/edit', 'fas fa-fw fa-user-edit', 1);
INSERT INTO `user_sub_menu` VALUES (4, 7, 'Menu Management', 'menu', 'fas fa-fw fa-folder', 1);
INSERT INTO `user_sub_menu` VALUES (5, 7, 'Submenu Management', 'menu/submenu', 'fas fa-fw fa-folder-open', 1);
INSERT INTO `user_sub_menu` VALUES (7, 6, 'Role', 'admin/role', 'fas fa-fw fa-user-tie', 1);
INSERT INTO `user_sub_menu` VALUES (8, 5, 'Change Password', 'user/changepassword', 'fas fa-fw fa-key', 1);
INSERT INTO `user_sub_menu` VALUES (9, 1, 'Berita', 'Berita', 'mdi mdi-newspaper menu-icon', 1);
INSERT INTO `user_sub_menu` VALUES (10, 2, 'Dokumen', 'Dokumen/doc', '', 1);
INSERT INTO `user_sub_menu` VALUES (11, 2, 'Agenda', 'Dokumen/agenda', '', 1);
INSERT INTO `user_sub_menu` VALUES (12, 2, 'Dokumentasi Video', 'Dokumen/video', '', 1);
INSERT INTO `user_sub_menu` VALUES (13, 2, 'Upload File', 'Dokumen/file', '', 1);
INSERT INTO `user_sub_menu` VALUES (14, 3, 'Data Desa', 'Entry/datadesa', '', 1);
INSERT INTO `user_sub_menu` VALUES (15, 3, 'Sub Bidang', 'Entry/subbidang', '', 1);
INSERT INTO `user_sub_menu` VALUES (16, 3, 'Data Kegiatan', 'Entry/datakegiatan', '', 1);
INSERT INTO `user_sub_menu` VALUES (17, 4, 'Laporan Kecamatan', 'Laporan/kecamatan', '', 1);
INSERT INTO `user_sub_menu` VALUES (18, 4, 'Laporan Desa', 'Laporan/desa', '', 1);
INSERT INTO `user_sub_menu` VALUES (19, 4, 'Rekap Kegiatan', 'Laporan/kegiatan', '', 1);
INSERT INTO `user_sub_menu` VALUES (20, 8, 'Data Survey', 'SKP', '', 1);
INSERT INTO `user_sub_menu` VALUES (21, 8, 'Biodata Surveyor', 'SKP/Biodata', '', 1);
INSERT INTO `user_sub_menu` VALUES (22, 8, 'Input SKP', 'SKP/TambahSKP', '', 1);
