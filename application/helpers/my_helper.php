...
{
	// Anda dapat menggunakan variabel super global CI3 untuk mengakses instance CI3
	$ci = get_instance();
	$id = dekrip($ci->session->userdata('id'));
	$data = $ci->db->get_where('user', ['id' => $id])->row_array();
	return $data[$field];
}
