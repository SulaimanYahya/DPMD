...
class TambahSKP extends CI_Controller
{
	...
	public function insert()
	{
		...
		$data = [
			...
			'foto_A1' 		 => str_replace(" ", "_", $foto_A1),
			'foto_A2' 		 => str_replace(" ", "_", $foto_A2),
			'foto_A3' 		 => str_replace(" ", "_", $foto_A3),
			'foto_A4' 		 => str_replace(" ", "_", $foto_A4),
			'foto_A5' 		 => str_replace(" ", "_", $foto_A5),
			'foto_A6' 		 => str_replace(" ", "_", $foto_A6),
			'foto_B1' 		 => str_replace(" ", "_", $foto_B1),
			'foto_B2' 		 => str_replace(" ", "_", $foto_B2),
			'foto_B3' 		 => str_replace(" ", "_", $foto_B3),
			'foto_B4' 		 => str_replace(" ", "_", $foto_B4),
			'foto_B5' 		 => str_replace(" ", "_", $foto_B5),
			'foto_B6' 		 => str_replace(" ", "_", $foto_B6),
			'foto_B7' 		 => str_replace(" ", "_", $foto_B7),
			'foto_C1' 		 => str_replace(" ", "_", $foto_C1),
			'foto_C2' 		 => str_replace(" ", "_", $foto_C2),
			'foto_C3' 		 => str_replace(" ", "_", $foto_C3),
		];
